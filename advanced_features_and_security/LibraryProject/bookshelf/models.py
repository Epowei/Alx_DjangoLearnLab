...
# Custom User Manager should be defined BEFORE the CustomUser model
...
class CustomUser(AbstractUser):
    ...
    objects = CustomUserManager()  # Add this line to use the custom manager
...
class UserProfile(models.Model):
    ...
    # Use settings.AUTH_USER_MODEL instead of hardcoding User or CustomUser
